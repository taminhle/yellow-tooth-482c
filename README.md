...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/yellow-tooth-482c)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/yellow-tooth-482c
```

A live public deployment of this template is available at [https://yellow-tooth-482c.templates.workers.dev](https://yellow-tooth-482c.templates.workers.dev)
